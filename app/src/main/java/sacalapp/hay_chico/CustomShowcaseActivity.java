...
/**
 * Created by jarvicfelipe on 31/10/2017.
 */
...
public class CustomShowcaseActivity extends Activity {
    ...
    private static class CustomShowcaseView implements ShowcaseDrawer {
        ...
        public CustomShowcaseView(Resources resources) {
            width = resources.getDimension(R.dimen.activity_horizontal_margin);
            height = resources.getDimension(R.dimen.activity_horizontal_margin);
            ...
            eraseColour = resources.getColor(R.color.rojo);
